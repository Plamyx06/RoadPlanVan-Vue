    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-[480px] rounded-lg px-6 py-12 relative">
      <div class="bg-beige-custom px-6 py-6 shadow rounded-lg">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-red-custom">
            Tu souhaites enregistrer ton Roadtrip ?
          </h2>
        </div>
        ...
        <div>
          <div class="relative mt-6">
            <div class="relative flex justify-center text-sm font-medium leading-6">
              <span class="text-xl px-6 text-red-custom"> Je m'inscris ou me connecte </span>
            </div>
          </div>
