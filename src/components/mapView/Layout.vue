...
<template>
    <div class=" absolute z-10  bg-white max-h-[20px] h-full w-full blur-2xl">
    </div>
    <div class=" w-full absolute z-10 flex justify-between items-center px-3 py-1">
        ...
        <div>
            <button class="shadow-sm" @click="handleUserButton">
                <UserCircleIcon class="h-8 w-8 text-red-custom  rounded-full lg:h-10 lg:w-10" />
            </button>
        </div>
