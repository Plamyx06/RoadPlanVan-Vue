  ...
  <div class="bg-beige-custom">
    ...
    <header class="absolute inset-x-0 top-0 z-10">
      <div class="flex justify-between items-center p-3">
        ...
        <div>
          <button type="button" @click="handleRegister" class="rounded-full hover:bg-white">
    ...
    <main>
      ...
      <div class="relative isolate overflow-hidden pb-16 pt-14 sm:pb-20">
        <img
          src="@/assets/main-van-on-road-desert.jpg"
          alt="van on road in desert"
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center rounded-lg">
              <p
                class="mt-6 text-2xl leading-8 uppercase text-white font-bold sm:text-4xl lg:text-6xl"
              >
      ...
      <div class="mt-20 sm:mt-20 bg-beige-custom px-3 lg:px-8">
          ...
          <div class="mx-auto max-w-7xl">
            <div class="md:flex md:justify-center md:items-center">
              <div class="md:flex-1 md:mr-5 md:mb-0">
                <p
                  class="text-center mt-2 text-3xl font-bold tracking-tight text-red-custom sm:text-4xl"
                >
        ...
        <div
          class="border-[1px] border-red-custom mx-20 rounded-full my-16 lg:mx-96 md:hidden"
        ></div>
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-7xl md:mt-32">
            <div class="md:flex md:justify-center md:items-center">
              <div class="flex-1 mb-4 md:ml-5 md:order-last">
                ...
                <p class="mt-6 text-lg leading-8 text-black text-center">
                  Avec autant de villes et de monuments, cela représente des heures de travail pour
                  réussir à les relier tout en étant sûr de ne pas se tromper.
                </p>
              </div>
              <div class="flex-1 md:mr-5">
                <img
                  src="@/assets/van-in-desert.jpg"
                  alt="van in desert"
          ...
          <div class="mx-auto max-w-7xl">
            <div class="text-center">
              ...
              <p class="mt-6 text-lg leading-8 text-black">
                Tu peux rechercher les villes que tu aimerais visiter et les ajouter à ton
                itinéraire. Tu disposeras d'un bouton pour les réorganiser, ce qui te permettra de
                trouver l'itinéraire le plus court incluant tous les lieux sélectionnés. Tu auras
                également la possibilité de modifier cet ordre si nécessaire.
              </p>
            </div>
          </div>
        </div>
        <div class="relative overflow-hidden mt-16">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <img
              src="@/assets/itinerary-exemple.jpg"
              alt="App screenshot"
          ...
          >
            <div v-for="feature in features" :key="feature.name" class="relative pl-9">
              <dt class="inline font-semibold text-gray-900">
                <component
                  :is="feature.icon"
                  class="absolute left-1 top-1 h-5 w-5 text-red-custom"
                  aria-hidden="true"
                />
                {{ feature.name }}<br />
              </dt>
      ...
      <div class="relative z-10 mt-32 bg-red-custom pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
        <div class="absolute inset-0 overflow-hidden" aria-hidden="true">
          <div class="absolute left-[calc(50%-19rem)] top-[calc(50%-36rem)] transform-gpu blur-3xl">
            <div
              class="aspect-[1097/1023] w-[68.5625rem] bg-gradient-to-r from-red-custom to-beige-custom opacity-25"
              style="
                clip-path: polygon(
                  74.1% 44.1%,
                  100% 61.6%,
        ...
        >
          ...
          <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure class="relative isolate pt-6 sm:pt-12">
              ...
              <blockquote
                class="text-xl font-semibold leading-8 text-beige-custom sm:text-2xl sm:leading-9"
              >
                <p>
